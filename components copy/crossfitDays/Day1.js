...
const day1 =()=>{
    ...
    data
    .ref('/users/Monday/crossfitLessons1/'+user.uid)
    .set({
    day: "Monday: ",
    name: user.email,
    time: "8:30/9:30"
...
console.log(user.uid)
    ...
    data
    .ref('/users/Monday/crossfitLessons2/'+user.uid)
    .set({
    day: "Monday: ",
    name: user.email,
    time: "12:30/13:30"
...
.then(() =>this.props.navigation.navigate("confirmation") )        }
     ...
     data
    .ref('/users/Monday/crossfitLessons3/'+user.uid)
    .set({
    day: "Monday: ",
    name: user.email,
    time: "14:30/15:30"
...
.then(() =>this.props.navigation.navigate("confirmation") )        }
     ...
     data
    .ref('/users/Monday/crossfitLessons/'+user.uid)
    .set({
    day: "Monday: ",
    name: user.email,
    time: "18:30/19:30"
...
.then(() =>this.props.navigation.navigate("confirmation") )        }
  ...
  .then(() =>this.navigation.navigate("confirmation") )
    ...
    alert('lesson cancelled')
         ...
         const cancelLesson4 =()=> {
    data
    .ref('/users/Monday/crossfitLessons4/'+user.uid)
    .remove()   
    alert('lesson cancelled')
 }
            ...
            const cancelLesson5 =()=> {
    data
    .ref('/users/Monday/crossfitLessons5/'+user.uid)
    .remove()  
    alert('lesson cancelled') 
 }
