...
const day2 =()=> {
    ...
    data
    .ref('/users/Tuesday/crossfitLessons1/'+user.uid)
    .set({
    day: "Tuesday: ",
    name: user.email,
    time: "8:30/9:30"
...
console.log(user.uid)
    ...
    data
    .ref('/users/Tuesday/crossfitLessons2/'+user.uid)
    .set({
    day: "Tuesday: ",
    name: user.email,
    time: "12:30/13:30"
...
.then(() =>this.props.navigation.navigate("confirmation") )        }
     ...
     data
    .ref('/users/Tuesday/crossfitLessons3/'+user.uid)
    .set({
    day: "Tuesday: ",
    name: user.email,
    time: "14:30/15:30"
...
.then(() =>this.props.navigation.navigate("confirmation") )        }
     ...
     data
    .ref('/users/Tuesday/crossfitLessons4/'+user.uid)
    .set({
    day: "Tuesday: ",
    name: user.email,
    time: "18:30/19:30"
...
.then(() =>this.props.navigation.navigate("confirmation") )        }
    ...
    data
    .ref('/users/Tuesday/crossfitLessons5/'+user.uid)
    .set({
    day: "Tuesday: ",
    name: user.email,
    time: "21:30/2:30"
