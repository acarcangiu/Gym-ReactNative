...
const day4 =()=> {
    ...
    data
    .ref('/users/Thursday/crossfitLessons1/'+user.uid)
    .set({
    name: user.email,
    time: "8:30/9:30"
  })
console.log(user.uid)
    ...
    data
    .ref('/users/Thursday/crossfitLessons2/'+user.uid)
    .set({
    name: user.email,
    time: "12:30/13:30"
  })
.then(() =>this.props.navigation.navigate("confirmation") )        }
     ...
     data
    .ref('/users/Thursday/crossfitLessons3/'+user.uid)
    .set({
    name: user.email,
    time: "14:30/15:30"
  })
.then(() =>this.props.navigation.navigate("confirmation") )        }
     ...
     data
    .ref('/users/Thursday/crossfitLessons4/'+user.uid)
    .set({
    name: user.email,
    time: "18:30/19:30"
  })
.then(() =>this.props.navigation.navigate("confirmation") )        }
    ...
    data
    .ref('/users/Thursday/crossfitLessons5/'+user.uid)
    .set({
    name: user.email,
    time: "21:30/2:30"
  })
